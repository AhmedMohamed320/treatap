                        ...
                        <div className={classes.text}>
                            <div>
                                ...
                                <p className={classes.sub}>
                                    الوقاية، التشخيص، العلاج، الأدوية، الفحوصات،
                                    التطعيمات، النظافة، الصحة، العافية، الرعاية،
                                    الحفاظ، النمط الحياة الصحي، النظام الغذائي.
                                </p>
                        ...
                        <div className={classes.service}>
                            <div>
                                ...
                                <div>
                                    ...
                                    <p>
                                        كشفك بقا سهل ودقه افضل مع وجود ملفك
                                        الطبي
                                    </p>
                                </div>
                            </div>
